...
public class PantallaCarga extends JFrame {
    ...
    private void crearComponentes() {
        ...
        // ---------------- GIF ENCIMA DEL DATO CURIOSO ----------------
        int gifAncho = 1920;
        int gifAlto = 200;
        Image gifEscalado = new ImageIcon(
                getClass().getResource("/Multimedia/utiles/ElementosGraficos/gif/Pantalla_de_Carga_Definitivo.gif"))
                .getImage().getScaledInstance(gifAncho, gifAlto, Image.SCALE_DEFAULT);
        JLabel lblGif = new JLabel(new ImageIcon(gifEscalado), SwingConstants.CENTER);
        int gifX = (1920 - gifAncho) / 2;
        int gifY = 820 - gifAlto;
        lblGif.setBounds(gifX, gifY, gifAncho, gifAlto);
        fondo.add(lblGif);
        // ---------------- FRANJA INFERIOR / DATO CURIOSO ----------------

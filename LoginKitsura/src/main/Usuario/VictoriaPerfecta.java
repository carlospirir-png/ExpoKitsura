...
public class VictoriaPerfecta extends JFrame {
    ...
    public VictoriaPerfecta() {
        ...
        fondo = new FondoPanel("/Multimedia/utiles/fondoCincoK.png");
    ...
    private void crearComponentes() {
        ...
        //---------------- MASCOTA ----------------
            ...
            ImageIcon iconMascota = new ImageIcon(getClass().getResource("/Multimedia/utiles/mascota5.png")); 
        ...
        ImageIcon paisajeIcon = new ImageIcon(getClass().getResource("/Multimedia/utiles/logofK.png"));
